...
lib LibLevelDB
  ...
  fun leveldb_write(db : Void*, woptions : Void*, batch_ptr : Void*, errptr : Void*) : Void
  ...
  # Batch
  fun leveldb_writebatch_create : Void*
  fun leveldb_writebatch_destroy(wb : Void*)
  fun leveldb_writebatch_put(wb : Void*, key : UInt8*, keylen : UInt64, val : UInt8*, vallen : UInt64) : Void
  fun leveldb_writebatch_delete(wb : Void*, key : UInt8*, keylen : UInt64) : Void
  # Snapshot
